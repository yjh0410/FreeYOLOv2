...
class Criterion(object):
    def __init__(self, 
        ...
        # loss weight
        loss_cfg = cfg['loss_weights'][cfg['cls_loss']]
        self.loss_cls_weight = loss_cfg['loss_cls_weight']
        self.loss_iou_weight = loss_cfg['loss_iou_weight']
        self.loss_dfl_weight = loss_cfg['loss_dfl_weight']
        # matcher
